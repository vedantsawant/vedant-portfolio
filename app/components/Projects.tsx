...
export default function Projects() {
  return (
    <section id="projects" className="bg-white item py-10 mx-auto content justify-center items-center">
      <div className="max-w-screen-xl mx-auto justify-center items-center">
        ...
        <div className="grid h-auto lg:grid-cols-3 items-center justify-items-center gap-5 xl:gap-10 px-10 m-auto">
          <ImageCard imageUrl={'/Vedant_Sawant.jpg'} color="bg-white">
          ...
          <ImageCard imageUrl={'/ea-logo.png'} color="bg-white">
          ...
          <ImageCard imageUrl={'/sbu-logo.png'} color="bg-white">
