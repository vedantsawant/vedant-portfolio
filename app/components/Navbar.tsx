...
export default function Navbar() {
  return (
    <nav className="fixed left-0 top-0 z-10 mx-auto flex h-auto w-full items-center border-b-4 border-black bg-white px-5 m500:h-16 ">
      <div className="mx-auto flex w-full items-center justify-center md:justify-end md:mb-0 max-w-screen-xl">
        ...
        <div className="hidden md:flex items-center text-base justify-end ">
          <a
            ...
            className="bg-sky-700 m-1 flex items-center justify-center rounded-md border-2 border-black p-2 shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] transition-all hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)]"
          >
          ...
          <a
            ...
            className="m-1 flex items-center justify-center rounded-md border-2 border-black p-2 shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] transition-all hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)]"
          >
